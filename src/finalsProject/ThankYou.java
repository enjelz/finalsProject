...
public class ThankYou extends JFrame {
	...
	public ThankYou() {
		...
		lblHms_1.setBounds(-12, 11, 156, 23);
		panel.add(lblHms_1);
		...
		JLabel lblNewLabel = new JLabel("We are pleased to inform you that your reservation request has been received and confirmed.");
		...
		JLabel lblNewLabel_1 = new JLabel("Thank you for choosing Cozy Hotel! We can't wait to make your stay exceptional.");
		lblNewLabel_1.setBounds(101, 305, 400, 14);
		panel.add(lblNewLabel_1);
		lblNewLabel_1.setFont(new Font("Tahoma", Font.ITALIC, 11));
		
		JLabel lblNewLabel_3 = new JLabel("Additionals:");
		...
		lblThankYouRemarks.setBounds(328, 259, 46, 14);
		panel.add(lblThankYouRemarks);
		
		JLabel lblThankYouAdditional = new JLabel("New label");
