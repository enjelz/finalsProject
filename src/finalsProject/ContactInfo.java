...
public class ContactInfo extends JFrame {
	...
	private void displayPayment() {
		textAreaPayment.setText("Room: "+RoomTypes.roomType+"\tPhp"+ String.format("%,.2f\n",RoomTypes.previousTotal)
				+ String.join("\n", RoomTypes.selectedAdditionals) +"\tPhp"+String.format("%,.2f",RoomTypes.totalMassage)
				+"\nTotal Amount Due: \tPhp"+String.format("%,.2f",RoomTypes.total));
	}
